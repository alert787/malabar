...
<head>
    ...
    <style type="text/css">
        ...
        table {border-collapse: collapse; width: 45%; text-align: justify; font-size: 16px; color: white;}
...
<body>
            ...
            <div class="container-fluid">
                <form method="post">
                    <center>
                      ...
                      <table>
                        <tr>
                            <td style="text-align: center;"><h3>Nama Akun : <?php echo $_SESSION['user']['namaUser']; ?></h3></td>
                        </tr>                        

                        <tr>
                            <td> 
                                Kata Sandi Lama<br>
                                <input type="password" name="lama" id="psw1" placeholder="Kata Sandi Lama...."><br>
                                <input type="checkbox" onclick="myFunction1()">Tampilkan
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                Kata Sandi Baru<br>
                                <input type="password" name="psw1" id="psw2" placeholder="Kata Sandi Baru...."><br>
                        ...
                        <tr>
                            <td>
                                Konfirmasi Kata Sandi Baru<br>
                                <input type="password" name="psw2" id="psw3" placeholder="Konfirmasi Kata Sandi Lama...."><br>
                                <input type="checkbox" onclick="myFunction3()">Tampilkan
                            </td>
                        </tr>
                    </table>
                    <br><br>
                    <button class="tombol" name="simpan">Ubah Profil</button>
                </center>
            </form>
        </div>
    </div>
    ...
    if (isset($_POST['simpan'])) {
        ...
        if((empty($pass_komfrim)) or (empty($pass)) or (empty($lama)))
        {
          echo '<script>
          swal({
            title: "Oops!",
