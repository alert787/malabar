...
$result = mysqli_query($koneksi,"SELECT * FROM barang where hargaBrg <> '0'");
...
<body>
    ...
    $res = "SELECT max(tglBeli) tglLast FROM `beli` join detailbeli on beli.kdBeli = detailbeli.kdBeli join barang on detailbeli.idBrg = barang.idBrg WHERE barang.hargaSewa = 0";
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper" style="background-color: #2a2b30; color: rgba(236, 240, 241,1.0)">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Data inventory barang</h4>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                <br>
                <center>
                    <p>Terakhir diperbaharui : <?php echo date("d-m-Y", strtotime($assc['tglLast'])) ?></p><br>
                    <div style="width: 90%; text-align: left;">
                        ...
                        <div class="inblock" style="width: 50%; text-align: right;">
                            <a href="tambahbrg.php" class="tomboltam">+ TAMBAH</a>
                        </div>
                    </div>
                    ...
                    <table style="margin-top: 25px">
                        ...
                        if (isset($_POST['submit'])) {
                            $nama = $_POST['cari'];
                            $brg = mysqli_query($koneksi,"SELECT * FROM barang where hargaBrg <> '0' and namaBrg like '%".$nama."%' ORDER BY `namaBrg` ASC");
                            while($barang = mysqli_fetch_assoc($brg)){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="detailbrg.php?id= <?php echo $barang['idBrg']; ?>" class="tombol">Detail</a>
                                    </td>
                                </tr>
                                <?php
                                $no++;
                            ...
                            $pagi = true;
                            $brg = mysqli_query($koneksi,"SELECT * FROM barang where hargaBrg <> '0' ORDER BY `namaBrg` ASC LIMIT $mulai, $halaman");
                            while($barang = mysqli_fetch_assoc($brg)){
                                ?>
                                <tr>
                                    <td><?php echo $no ?></td>                      
