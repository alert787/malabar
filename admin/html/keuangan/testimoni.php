        ...
        <div class="page-wrapper" style="background-color: #2a2b30; color: rgba(236, 240, 241,1.0)">
            ...
            <div class="container-fluid">
                <center>
                    ...
                    <table>
                        <tr>
                            <td width="20%">Nama Konsumen</td>
                            <td width="10%">:</td>
                            <td width="70%">Yuuki Asuna</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <img src="../../assets/images/tes1.jpg" width="500px">
                            </td>
                        </tr>
                    </table><br>
                    <a href="ubahtestimoni.php" class="tombol">Ubah</a>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td style="text-align: center;">
                                <img src="../../assets/images/tes2.jpg" width="500px">
                            </td>
                        </tr>
                    </table><br>
                    <a href="ubahtestimoni.php" class="tombol">Ubah</a>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td style="text-align: center;">
                                <img src="../../assets/images/tes3.jpg" width="500px">
                            </td>
                        </tr>
                    </table><br>
                    <a href="ubahtestimoni.php" class="tombol">Ubah</a>
