...
$query2 = "SELECT sum(TotalHarga) th FROM `transaksi` where transaksi.tglTransaksi like '2019-09%' UNION SELECT sum(detailbeli.subTotal) from detailbeli join beli on beli.kdBeli = detailbeli.kdBeli where beli.tglBeli like '$datenow%' ";
