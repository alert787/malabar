...
$result = mysqli_query($koneksi,"select * from jual join transaksi on transaksi.kdTransaksi = jual.kdTransaksi");
...
<head>
    ...
    <title>Admin | Penjualan Barang</title>
    <!-- Custom CSS -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Detail Penjualan Barang</h4>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
                ...
                <center>
                    ...
                    <table>
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $ambil = mysqli_query($koneksi,"select * from jual join transaksi on transaksi.kdTransaksi = jual.kdTransaksi where transaksi.kdTransaksi like '%".$kdTransaksi."%' ORDER BY `transaksi`.`tglTransaksi` DESC");
                            if ($ambil)
                            {
                        ...
                        {
                            $pagi = true;
                            $ambil = mysqli_query($koneksi,"select * from jual join transaksi on transaksi.kdTransaksi = jual.kdTransaksi ORDER BY `transaksi`.`tglTransaksi` DESC LIMIT $mulai, $halaman");
                            if ($ambil)
                            {
                                while($pecah = mysqli_fetch_assoc($ambil)){ 
                                    $idBrg = $pecah['idBrg'];
