...
$result = mysqli_query($koneksi,"SELECT * FROM barang where hargaSewa <> '0'");
                ...
                <center>
                    ...
                    <table style="margin-top: 25px">
                        ...
                        if (isset($_POST['submit'])) {
                            $nama = $_POST['cari'];
                            $brg = mysqli_query($koneksi,"SELECT * FROM barang where hargaSewa <> '0' and namaBrg like '%".$nama."%' ORDER BY `namaBrg` ASC");
                            ...
                            $pagi = true;
                            $brg = mysqli_query($koneksi,"SELECT * FROM barang where hargaSewa <> '0' ORDER BY `namaBrg` ASC LIMIT $mulai, $halaman");
                            while($barang = mysqli_fetch_assoc($brg)){
                                ?>
                                <tr>
                                    <td><?php echo $no ?></td>                      
