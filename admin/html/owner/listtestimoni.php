                            ...
                            if ($ambil)
                            {
                                while($pecah = mysqli_fetch_assoc($ambil)){ 
                                    ...
                                    <tr>
                                        ...
                                        <form method="post">
                                            <input name="kd" hidden value="<?php echo $kdt; ?>"></input>
                                            <?php
                                            if ($pecah['status'] == 'Favorite') {
                                                echo "<td><button class='btn-fav' name='fav'>Favorite</button></td>";
                                            }
                                            elseif ($pecah['status'] == 'unFavorite'){
                                                echo "<td><button class='btn-un' name='un'>unFavorite</button></td>";
                                            }
                                            ?>
                                        </form>
                                    </tr>
                            ...
                            if ($ambil)
                            {
                                ...
                                while($pecah = mysqli_fetch_assoc($ambil)){ 
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $pecah['komen']; ?></td>
                                        <form method="post">
                                            <input name="kd" hidden value="<?php echo $kdTransaksi; ?>"></input>
                                            <?php
                                            if ($pecah['status'] == 'Favorite') {
                                                echo "<td><button class='btn-fav' name='fav'>Favorite</button></td>";
                                            }
