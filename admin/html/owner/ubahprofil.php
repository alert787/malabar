              ...
              <table>
                <form method="post">
                    ...
                    <tr>
                        <td> 
                            Nama Lengkap<br>
                            <input type="text" name="nama" id="nama" value="<?php echo $_SESSION['user']['namaUser']; ?>">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            Alamat<br>
                            <input type="text" name="alamat" id="alamat" value="<?php echo $_SESSION['user']['Alamat']; ?>">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            Email<br>
                            <input type="text" name="mail" id="mail" value="<?php echo $_SESSION['user']['Email']; ?>">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            No. Telp<br>
                            <input type="text" name="telp" id="telp" value="<?php echo $_SESSION['user']['Telp']; ?>">
                        </td>
                    </tr>
                </table>
                <br><br>
